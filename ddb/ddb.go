...
func (db *Client) userFromAppleSignIn(ctx context.Context, identityToken string) (*User, error) {
	return nil, nil
}
...
// should be
func (db *Client) table(cfg *Config, name string, schema any) (dynamo.Table, error) {
